...
class Modern_Blogger_Icon_Selector extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                      <div class="social-icon-search">
                          <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'modern-blogger'); ?>">
                      </div>
                    <?php
                    $modern_blogger_font_awesome_icon_array = modern_blogger_font_awesome_icon_array();
                    foreach ($modern_blogger_font_awesome_icon_array as $modern_blogger_font_awesome_icon) {
                            $icon_class = $this->value() == $modern_blogger_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($modern_blogger_font_awesome_icon).'"></i>
                            <span class="modern-blogger-social-class">'.esc_attr($modern_blogger_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function modern_blogger_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'modern_blogger_customizer_script' );

if(!function_exists('modern_blogger_font_awesome_icon_array')){
    function modern_blogger_font_awesome_icon_array(){
