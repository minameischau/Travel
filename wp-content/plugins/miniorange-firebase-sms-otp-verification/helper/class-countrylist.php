...
if ( ! class_exists( 'CountryList' ) ) {
	...
	class CountryList {
		 ...
		 */
		public static function get_country_code_list() {
			return self::$countries;
		}
		/**
		 * Deprecated function: returns default country code.
		 */
		public static function get_default_country_code_deprecated() {
			return ! MoUtility::is_blank( get_mofr_option( 'default_country_code' ) ) ? get_mofr_option( 'default_country_code' ) : null;
		}
		/**
		...
		public static function is_country_selected_deprecated( $value ) {
			return ! MoUtility::is_blank( get_mofr_option( 'default_country_code' ) )
						&& get_mofr_option( 'default_country_code' ) === $value;
		}
		/**
		 * Returns default country data.
		 */
		public static function get_default_country_data() {
			return ! MoUtility::is_blank( get_mofr_option( 'default_country' ) )
						? maybe_unserialize( get_mofr_option( 'default_country' ) ) : null;
		}
		...
		public static function get_default_countrycode() {
			$old_value = self::get_default_country_code_deprecated();
		...
		/**
		 * Function returns the length of the phone number.
		 */
		public static function get_phone_length() {
			$old_value = self::get_default_country_code_deprecated();
			$new_value = self::get_default_country_data();
			if ( ! MoUtility::is_blank( $new_value ) ) {
