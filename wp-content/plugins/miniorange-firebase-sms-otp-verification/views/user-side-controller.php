<?php
/**
 * Load user view for contact us tab.
 *
...
add_action(
	...
	function () {
		ob_start();
		echo '<div style="display:none;" id="mo_contact_us" class="w-[368px] contact-us-container duration-300"> 
						<div class="flex gap-mofr-4 relative justify-end">
								...
								<div class="overflow-hidden hidden peer-checked:block absolute right-mofr-0 bottom-mofr-0 bg-white shadow-lg rounded-smooth border animate-fade-in-up">
										...
										<form name="f" method="post" action="" class="flex flex-col gap-mofr-3 p-mofr-6">
												<p class="leading-loose" style="font-size: 14px;">Need any help? Just send us a query and we will get in touch.</p>
												<input type="hidden" name="option" value="mofr_validation_contact_us_query_option"/>
													
																<input type="email" class="mofr-input" id="query_email" name="query_email" value=""
																		placeholder="' . esc_attr( mofr_( 'Enter your Email' ) ) . '" required />
													
														
																<input type="text" class="mofr-input" name="query_phone" id="query_phone" value=""
												...
												<a href="mailto:otpsupport@xecurify.com" class="mofr-button secondary">
														...
														<span style="font-size: 14px;">Email us at otpsupport@xecurify.com<span>
												</a>
										</form>     
							</div>
						</div>
