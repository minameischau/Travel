...
echo '  <div class="mofr-modal-backdrop" style="display:none">
			...
			<div class="mofr_registration_support_layout fixed mofr-otp-hidden" id="support_form">
				<h3>' . esc_html( mofr_( 'CONTACT US ' ) ) . '</h3>
				<p>' . esc_html( mofr_( 'Need any help? Just send us a query and we will get in touch. ' ) ) . '</p>
					...
					<p>You can also leave us a mail at <span class = "mofr_support_input_label_highlight">' . esc_html( $support ) . '</span></p>
			</div>
		</div>
